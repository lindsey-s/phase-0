...
I actually didn't have much trouble passing these tests. I had to look up a few pieces of
syntax here and there so I'll keep up with that strategy if I get stuck. JavaScript seems
simpler than Ruby somehow and even better documented.

How difficult was it to add and delete properties outside of the object itself?

It was surprisingly easy - no methods really - just our friends the dot and =
(and the keyword delete)

What did you learn about manipulating objects in this challenge?

That it's easy as pie! It does seem like it might be too easy and could lead to mistakes if
I'm not careful about understanding each line of code!
