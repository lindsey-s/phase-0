...
#         product > 9 ? product.to_s.split(//) : product
...
# it's clear we'll need to keep this in mind during psuedocoding. I also had a hard time
# getting the refactor to pass the rspec tests though it was returning correctly in irb...
